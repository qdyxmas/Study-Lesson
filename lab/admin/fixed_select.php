          ...
          <tr>
            <td width="36%" align="center">
              <select name="seltype" id="seltype">
                <option value="cost_center">成本中心描述</option>
                <option value="cost_id">资产编号</option>
                <option value="cost_name">资产名称</option>
                <option value="cost_model">规格型号</option>
                <option value="position">放置地点</option>
...
<table width="799" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="table" >
      ...
      <tr>
        ...
        <td width="11%" align="center" bgcolor="#FFFFFF">成本中心</td>
        <td width="14%" align="center" bgcolor="#FFFFFF">资产编号</td>
        <td width="16%" align="center" bgcolor="#FFFFFF">资产名称</td>
        <td width="11%" align="center" bgcolor="#FFFFFF">规格型号</td>
        <td width="16%" align="center" bgcolor="#FFFFFF">放置地点</td>
...
<a href="fixed_update.php?id=<?php echo $rows[id] ?>" class="trlink">修改</a></td>
</tr>
	<?php
	}
?>
